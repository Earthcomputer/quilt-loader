...
import net.fabricmc.loader.impl.entrypoint.minecraft.EntrypointPatchBranding;
import net.fabricmc.loader.impl.entrypoint.minecraft.EntrypointPatchHook;
import net.fabricmc.loader.impl.launch.common.FabricLauncherBase;
import net.fabricmc.loader.impl.metadata.BuiltinModMetadata;
import net.fabricmc.loader.impl.minecraft.McVersionLookup;
import net.fabricmc.loader.impl.minecraft.McVersion;
...
public class MinecraftGameProvider implements GameProvider {
	...
	public void launch(ClassLoader loader) {
		...
		if (envType == EnvType.CLIENT && targetClass.contains("Applet")) {
			targetClass = "net.fabricmc.loader.impl.entrypoint.applet.AppletMain";
		}
