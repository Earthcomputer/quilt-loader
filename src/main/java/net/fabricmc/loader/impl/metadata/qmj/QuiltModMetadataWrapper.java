...
import net.fabricmc.loader.api.LoaderValue;
import net.fabricmc.loader.api.ModContributor;
import net.fabricmc.loader.api.ModLicense;
...
public class QuiltModMetadataWrapper implements LoaderModMetadata {
	...
	@Override
	public InternalModMetadata asFabricModMetadata() {
		return quiltMeta;
	}
	...
	public Collection<ModDependency> getDepends() {
		...
		throw new UnsupportedOperationException("Fabric dependencies can not be represented as a Fabric construct!");
	}
