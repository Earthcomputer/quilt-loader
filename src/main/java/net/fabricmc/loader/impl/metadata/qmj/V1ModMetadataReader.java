...
package net.fabricmc.loader.impl.metadata.qmj;
...
import net.fabricmc.loader.api.LoaderValue.LObject;
import net.fabricmc.loader.api.LoaderValue.LType;
import net.fabricmc.loader.impl.VersionConstraintImpl;
import net.fabricmc.loader.impl.metadata.qmj.JsonLoaderValue.ArrayImpl;
import net.fabricmc.loader.impl.metadata.qmj.JsonLoaderValue.ObjectImpl;

import static net.fabricmc.loader.impl.metadata.qmj.ModMetadataReader.parseException;
