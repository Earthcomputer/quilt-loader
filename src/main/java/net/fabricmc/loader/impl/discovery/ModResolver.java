...
import net.fabricmc.json5.exception.ParseException;
...
import net.fabricmc.loader.impl.metadata.FabricModMetadataReader;
import net.fabricmc.loader.impl.metadata.ParseMetadataException;
import net.fabricmc.loader.impl.metadata.qmj.ModMetadataReader;
import net.fabricmc.loader.impl.metadata.qmj.ModProvided;
import net.fabricmc.loader.impl.solver.ModSolveResult;
import net.fabricmc.loader.impl.solver.ModSolver;
 ...
 * for the first job is {@link #resolve(FabricLoaderImpl)} which performs all of the work for loading mods. */
public class ModResolver {
	...
	public ModResolver(FabricLoaderImpl loader) {
	...
	public static String getReadablePath(FabricLoaderImpl loader, ModCandidate c) {
	...
	class UrlProcessAction extends RecursiveAction {
		...
		protected void compute() {
			...
			} catch (NoSuchFileException notFabric) {
	...
	public ModSolveResult resolve(FabricLoaderImpl loader) throws ModResolutionException {
