...
import net.fabricmc.loader.impl.entrypoint.minecraft.hooks.EntrypointUtils;
import net.fabricmc.loader.impl.game.GameProvider;
import net.fabricmc.loader.impl.game.MinecraftGameProvider;
import net.fabricmc.loader.impl.launch.common.FabricLauncherBase;
import net.fabricmc.loader.impl.launch.common.FabricMixinBootstrap;
...
public abstract class FabricTweaker extends FabricLauncherBase implements ITweaker {
	...
	public void injectIntoClassLoader(LaunchClassLoader launchClassLoader) {
		...
		launchClassLoader.registerTransformer("net.fabricmc.loader.impl.launch.FabricClassTransformer");
