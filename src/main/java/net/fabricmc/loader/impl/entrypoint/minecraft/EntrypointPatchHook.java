...
package net.fabricmc.loader.impl.entrypoint.minecraft;

import net.fabricmc.api.EnvType;
import net.fabricmc.loader.impl.entrypoint.EntrypointPatch;
			...
			if (type == EnvType.SERVER) {
				...
				if(!is20w22aServerOrHigher) {
					...
					if (serverStartMethod == null) {
						...
						serverStartIt.add(new FieldInsnNode(Opcodes.GETSTATIC, "org/quiltmc/loader/impl/FabricLoaderImpl", "INSTANCE", "Lorg/quiltmc/loader/impl/FabricLoaderImpl;"));
						serverStartIt.add(new InsnNode(Opcodes.SWAP));
						serverStartIt.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "org/quiltmc/loader/impl/FabricLoaderImpl", "setGameInstance", "(Ljava/lang/Object;)V", false));
					}
