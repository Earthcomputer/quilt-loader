...
import net.fabricmcold.loader.api.FabricLoader;
import net.fabricmcold.loader.api.MappingResolver;
import net.fabricmcold.loader.api.ModContainer;
import net.fabricmcold.loader.api.entrypoint.EntrypointContainer;

import net.fabricmcold.api.EnvType;
...
public class Quilt2FabricLoader implements FabricLoader {
	...
	public <T> List<EntrypointContainer<T>> getEntrypointContainers(String key, Class<T> type) {
		...
		try {
			...
			throw new net.fabricmcold.loader.api.EntrypointException(e.getKey(), e);
		}
	}
